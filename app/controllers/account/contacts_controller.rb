class Account::ContactsController < Account::ApplicationController
  ...
  # GET /account/companies/:company_id/contacts
  # GET /account/companies/:company_id/contacts.json
  def index
  ...
  # GET /account/companies/:company_id/contacts/new
  def new
  end
  ...
  # POST /account/companies/:company_id/contacts
  # POST /account/companies/:company_id/contacts.json
  def create
    respond_to do |format|
      if @contact.save
        format.html { redirect_to [:account, @company, :contacts], notice: I18n.t("contacts.notifications.created") }
  ...
  def destroy
    @contact.destroy
    respond_to do |format|
      format.html { redirect_to [:account, @company, :contacts], notice: I18n.t("contacts.notifications.destroyed") }
